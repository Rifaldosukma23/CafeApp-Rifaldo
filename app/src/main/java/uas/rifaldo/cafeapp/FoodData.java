...
public class FoodData {
    ...
    public static ArrayList<Food> getData(Context context) {
        ...
        list.add(new Food(
                "Caphuchino",
                "Caphuchino adalah minuman khas Italia yang dibuat dari espreso dan susu, tetapi referensi lain juga ada yang menyebutkan bahwa kapucino berawal dari biji biji kopi tentara Turki yang tertinggal setelah peperangan yang di pimpin oleh Kara Mustapha Pasha di Wina, Austria melawan tentara gabungan Polandia-Germania.",
                "Rp.8000",
                context.getDrawable(R.drawable.cappuchino)));
        list.add(new Food(
                "Donut",
                "Donut adalah penganan yang digoreng, dibuat dari adonan tepung terigu, gula, telur, dan mentega. Donat yang paling umum adalah donat berbentuk cincin dengan lubang di tengah dan donat berbentuk bundar dengan isian manis, seperti selai, jelly, krim, dan custard.",
                "Rp.4000",
